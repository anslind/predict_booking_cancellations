# Hotel Bookings
## Overview
In this dataset, we will be analyzing two hotels that are located in Portugal.  One is a resort hotel and the other is a city hotel.  We want to predict whether some one will cancel a booking based on the data that we have.
